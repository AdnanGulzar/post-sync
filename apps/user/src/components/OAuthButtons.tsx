...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 48 48" className="h-4 w-4" aria-hidden="true">
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.5 0 10.4-2 14.1-5.4l-6.5-5.5C29.6 34.9 26.9 36 24 36c-5.2 0-9.6-3.3-11.3-8l-6.6 5.1C9.6 39.6 16.3 44 24 44z"
      />
      <path
        fill="#1976D2"
...
export default function OAuthButtons() {
  ...
  async function continueWithGoogle() {
    ...
    setPending(true);
    try {
      const { url } = await api.get<{ url: string }>('/auth/oauth/google');
